...
export default function CountriesSwiper() {
  ...
  const panel = (
    <div className="w-full bg-[#FAF3e0] px-4 py-10 md:py-14 h-full flex flex-col justify-center">
          ...
          >
            ...
            <button
              onClick={goToPrev}
              className="absolute left-0 z-50 bg-[#FAF3e0] w-10 h-10 rounded-full shadow-lg flex items-center justify-center transition-colors border-2 border-[#808080] hover:bg-[#f0e8d0]"
            ...
            <button
              onClick={goToNext}
              className="absolute right-0 z-50 bg-[#FAF3E0] w-10 h-10 rounded-full shadow-lg flex items-center justify-center transition-colors border-2 border-[#808080] hover:bg-[#f0e8d0]"
          ...
          <div className="text-center mt-6">
            <h3 className="text-[22px] font-medium font-secondary text-[#0d173f]">
              Study In <span className="text-[#C44200]">{currentDestination.name}</span>
            </h3>
  ...
  return (
    <div className="relative bg-[#FAF3e0] z-40">
      <div
        ref={sentinelRef}
      ...
      />
      {!isFixed ? (
        <div className="sticky top-0 h-screen bg-[#FAF3e0] z-40 overflow-hidden">{panel}</div>
      ) : (
        <>
          <div className="h-screen" aria-hidden="true" />
          <div className="fixed top-0 left-0 w-full h-screen bg-[#FAF3e0] z-40 overflow-hidden">
            {panel}
          </div>
        </>
      )}
